#Poniżej znajduje się definicja klasy z właściwością zdefiniowaną w "standardowy" sposób.
# Zmień ją tak, żeby właściwości były definiowane przy pomocy dekoratorów
